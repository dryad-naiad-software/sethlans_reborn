...
pytest.importorskip("PySide6", reason="PySide6 required for notifications")
...
from shared.tray import notifications  # noqa: E402
from shared.tray.notifications import (  # noqa: E402
    APP_NAME,
    NotificationEvent,
    dispatch,
)
...
class TestHappyPath:
    ...
    def test_no_warning_logs_on_success(self, tray, mocker, caplog):
        ...
        with caplog.at_level(
            logging.WARNING, logger=notifications.logger.name,
        ):
            dispatch(tray, NotificationEvent("T", "M"))
