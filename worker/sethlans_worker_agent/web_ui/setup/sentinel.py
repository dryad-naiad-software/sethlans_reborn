...
"""
Setup-complete sentinel file management for the worker agent.
...
Ported from ``manager/workers/services/sentinel.py`` with identical
atomic write and permission patterns.
"""
